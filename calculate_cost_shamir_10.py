...
def esimate_circuits(path,baseline):
	...
	for circuit in circuits:
		...
		with open(path+"/"+circuit, 'r') as file:
			...
			for line in file:
				if ":1" in line:
					cost_upgrade, cost_input_share_high,cost_input_share_low,cost_rerand,cost_output_reveal_low,cost_output_reveal_high = costs(4)
...
esimate_circuits("BaselineCircuits/Shamir/10",True)
esimate_circuits("OptimizedCircuits/Shamir/10",False)